...
Dataframes in R can be appended using the `dplyr::bind_rows()` function. The advantage of this function is that it appends the dataframes that have a different number of columns. The dataframes are appended based on column names. 
...
pagedown::chrome_print("02_datamanipulation.html", output = "02_datamanipulation.pdf")
```
