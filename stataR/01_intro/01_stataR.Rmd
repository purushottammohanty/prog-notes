...
The function `is.na()` is a boolean operator (i.e. it only gives `TRUE` or `FALSE`) use to identify whether an object or element within an object is missing.     
    
Another uselful function is `na.rm = TRUE`
